...
func attempt_advance_frame(t: int, l: int, delta: float) -> bool:
	...
	tsas.texture = frame_data[t][l]["tilesheets"][frame_data[t][l]["frame_pos"]]
	if tsas.texture:
...
func sync_tilemaps():
	frame_0_layer.tile_map_data = tile_map_layer.tile_map_data
	frame_1_layer.tile_map_data = tile_map_layer.tile_map_data
	frame_2_layer.tile_map_data = tile_map_layer.tile_map_data
